...
namespace Glympse.EnRoute.UWP
{
    ...
    {
        private GlympseApiDll::Glympse.GPrimitive _raw;

        public Primitive(GlympseApiDll::Glympse.GPrimitive raw)
        {
            _raw = raw;
        }
        ...
        {
            return _raw.merge((GlympseApiDll::Glympse.GPrimitive) from.raw(), overrideTarget);
        }
        ...
        {
            _raw.put(key, (GlympseApiDll::Glympse.GPrimitive) value.raw());
        }
        ...
        {
            _raw.put((GlympseApiDll::Glympse.GPrimitive) value.raw());
        }
        ...
        {
            _raw.insert(index, (GlympseApiDll::Glympse.GPrimitive) value.raw());
        }

        public void put(int index, GPrimitive value)
        {
            _raw.put(index, (GlympseApiDll::Glympse.GPrimitive) value.raw());
        }
        ...
        {
            _raw.remove((GlympseApiDll::Glympse.GPrimitive) value.raw());
        }
    }
}
